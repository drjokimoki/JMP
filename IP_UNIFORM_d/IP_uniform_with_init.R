...
saveRDS(res_list, file="/Users/boris/Desktop/RSShapley/Combination_Monte/Final/codess/JMP/IP_UNIFORM/final_list.RData")
...
for(i in 1:length(res_list)){
  ...
  #unpack a 3D array
  mat <-res_list[[i]][[2]]
  form = sprintf('IP_uniform_Shapley_%s.csv', ae)
