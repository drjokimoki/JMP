...
#saveRDS(res_list, file="/Users/boris/Desktop/RSShapley/Combination_Monte/Final/codess/JMP/GDP_constrained/final_list_covid_all_k.RData")
...
summary_results1$actual <- actual_y
summary_results <- data.frame(RS_mean = aaa, MEAN_mean = bb, actual = actual_y)
