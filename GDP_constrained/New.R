...
summary_results$MEAN_mean[c(82,83)]

mean(abs(summary_results$MEAN_mean[-c(82,83)] - summary_results$actual[-c(82,83)]), na.rm = TRUE)
mean(abs(summary_results$RS_mean[-c(82,83)]   - summary_results$actual[-c(82,83)]), na.rm = TRUE)
sqrt(mean((summary_results$MEAN_mean[-c(82,83)] - summary_results$actual[-c(82,83)])^2, na.rm = TRUE))
sqrt(mean((summary_results$RS_mean[-c(82,83)]   - summary_results$actual[-c(82,83)])^2, na.rm = TRUE))
